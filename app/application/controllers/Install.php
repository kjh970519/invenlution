...
class Install extends CI_Controller
{
	...
	public function _create_tables()
	{
        ...
        $this->dbforge->add_key('unq_id', true);
        if ($this->dbforge->create_table('test', true) === false) {
            return false;
        }
        ...
        if ($this->dbforge->create_table('naver_goods', true) === false) {
            return false;
        }
        $sql = "ALTER TABLE cb_naver_goods 
...
//			$this->Board_meta_model->save($brd_id, $metadata);
			...
			$insertdata = array(
				'men_parent' => 0,
				'men_name' => '네이버 리뷰',
				'men_link' => group_url('naver-review'),
				'men_desktop' => 1,
				'men_mobile' => 1,
				'men_order' => 10,
			);
			...
			$insertdata = array(
				'men_parent' => $men_id,
				'men_name' => '네이버스토어 상품',
				'men_link' => board_url('naver-review-goods'),
				'men_desktop' => 1,
				'men_mobile' => 1,
				'men_order' => 11,
			);
...
//			$this->Menu_model->insert($insertdata);
			...
			$insertdata = array(
				'men_parent' => $men_id,
				'men_name' => '#키워드',
				'men_link' => board_url('instagram-skyword'),
				'men_desktop' => 1,
				'men_mobile' => 1,
				'men_order' => 21,
			);
